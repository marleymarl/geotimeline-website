...
Clone your fork to your local machine and CD into the directory 

Run `npm install` from the project directory ⚠️ DON'T use Yarn ⚠️

When that's finished, run `npm start` and your default browser will open up `localhost:3000`
